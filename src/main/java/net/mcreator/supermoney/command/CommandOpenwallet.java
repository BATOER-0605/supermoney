...
package net.mcreator.supermoney.command;
...
public class CommandOpenwallet extends ElementsSupermoneyMod.ModElement {
	public CommandOpenwallet(ElementsSupermoneyMod instance) {
		super(instance, 22);
	}

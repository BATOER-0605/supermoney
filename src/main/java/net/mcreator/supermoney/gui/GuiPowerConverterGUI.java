...
import net.mcreator.supermoney.procedure.ProcedurePowerComverterGUI;
...
public class GuiPowerConverterGUI extends ElementsSupermoneyMod.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiPowerConverterGUI(ElementsSupermoneyMod instance) {
		super(instance, 29);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 17, 42) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 132, 41) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("supermoney:textures/power_converter_gui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u8CA1\u529B\u5909\u63DB\u30FB\u5897\u5E45\u5668", 7, 9, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 59, this.guiTop + 40, 50, 20, "ïœä∑/ëùïù"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedurePowerComverterGUI.executeProcedure($_dependencies);
			}
		}
	}

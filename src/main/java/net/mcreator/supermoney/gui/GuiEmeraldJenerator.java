...
package net.mcreator.supermoney.gui;
...
import net.mcreator.supermoney.procedure.ProcedureEmeraldJenerate;
...
public class GuiEmeraldJenerator extends ElementsSupermoneyMod.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiEmeraldJenerator(ElementsSupermoneyMod instance) {
		super(instance, 24);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 20, 43) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 39, 43) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 125, 43) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				SupermoneyMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("supermoney:textures/emerald_jenerator.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u30A8\u30E1\u30E9\u30EB\u30C9\u5FA9\u5143", 9, 8, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 70, this.guiTop + 41, 35, 20, "•œŒ³"));
		}

		@Override
		protected void actionPerformed(GuiButton button) {
			SupermoneyMod.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
		...
		if (buttonID == 0) {
			{
				...
				ProcedureEmeraldJenerate.executeProcedure($_dependencies);
			}
		}
	}

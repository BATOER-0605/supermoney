...
public class GuiNormalWallet extends ElementsSupermoneyMod.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiNormalWallet(ElementsSupermoneyMod instance) {
		super(instance, 20);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 8, 25) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 26, 25) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 45, 25) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("supermoney:textures/normal_wallet.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u304A\u8CA1\u5E03", 6, 7, -12829636);
		}

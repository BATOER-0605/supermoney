...
import net.mcreator.supermoney.procedure.ProcedureMoneyJenerate;
...
public class GuiMoneyjanerator extends ElementsSupermoneyMod.ModElement {
	public static int GUIID = 1;
	public static HashMap guistate = new HashMap();
	public GuiMoneyjanerator(ElementsSupermoneyMod instance) {
		super(instance, 18);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 25, 44) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 133, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 115, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("supermoney:textures/moneyjanerator.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("\u9020\u5E63\u5C40", 9, 8, -12829636);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 60, this.guiTop + 43, 35, 20, "‘¢•¼"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureMoneyJenerate.executeProcedure($_dependencies);
			}
		}
	}
